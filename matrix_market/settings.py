"""
Django settings for matrix_market project.
...
SECRET_KEY = '^$ziu#!icqq1)+288k77p8zdoe=@hhnt-nz_0)fx7%67j(rok9'
...
ROOT_URLCONF = 'matrix_market.urls'
...
WSGI_APPLICATION = 'matrix_market.wsgi.application'
